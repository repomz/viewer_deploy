...
`YANDEX_BUCKET`. Локальный постоянный том для пользовательских файлов не
создаётся: при недоступности Object Storage файловые операции возвращают
ошибку, не занимая место на сервере.
